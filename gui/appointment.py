...
class Ui_Appointment(object):
    def setupUi(self, MainWindow):
        ...
        self.receptionTable.setStyleSheet("background-color:#FDF5E6;")
        ...
        self.doctorInput.setStyleSheet("background-color:#FDF5E6;")
        ...
        self.patientInput.setStyleSheet("background-color:#FDF5E6;")
